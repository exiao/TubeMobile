angular.module('starter.controllers', [])
    ...
    .controller('CampaignsCtrl', function ($scope, Campaigns) {
        ...
        $scope.cadreon_campaigns = ['yay'];
        $scope.accuen_campaigns = ['yay'];
        $scope.btacy_campaigns = ['yay'];
        $scope.rtb_tests_campaigns = [{campaign_name: 'hard'}, {campaign_name: 'coded'}];
    })
    ...
    .controller('CampaignsDetailCtrl', function ($scope, $stateParams, $http, Campaigns, Placements, DateState, $location) {
        ...
        $scope.campaign = {campaign_name: 'I am a test campaign name'};
        $scope.placements = [{placement_name: 'test'}, {placement_name: 'placements'}];
        $scope.impressions = 5000000000;
